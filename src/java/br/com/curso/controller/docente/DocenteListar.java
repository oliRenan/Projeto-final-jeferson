...
@WebServlet(name = "DocenteListar", urlPatterns = {"/DocenteListar"})
public class DocenteListar extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Problemas no servelet ao Listar docente !Erro:"+ex.getMessage());
            ex.printStackTrace();
        }
    }
