...
public class DocenteCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int numeroMaticula = Integer.parseInt(request.getParameter("numeromaticula"));
            String situcacao = request.getParameter("situcacao");
            
            Docente oDocente = new Docente(idDocente, numeroMaticula, situcacao, idPessoa, nomePessoa, contato);
            //generic dao falta
